namespace GameControllerLib.Definitions
{
	public class PS4
	{
		...
		public static readonly int LeftJoystickHorizontal = 4;
		public static readonly int LeftJoystickVertical = 3;
		public static readonly int RightJoystickHorizontal = 0;
		public static readonly int RightJoystickVertical = 1;
	}
}